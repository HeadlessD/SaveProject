...
- (void)updateGraph {
    ...
    height = CGRectGetHeight(self.bounds);
    if (self.myType==WYLineChartViewTypeOne) {
        frame = CGRectMake(self.frame.size.width - _calculator.yAxisViewWidth-8, 0, _calculator.yAxisViewWidth, height);
    }else
    {
    ...
    height = _calculator.xAxisViewHeight;
    ...
    if (!_verticalReferenceLineGraph) {
        ...
        if (self.myType ==WYLineChartViewTypeTwo) {
