...
+ (void)show:(NSString *)text icon:(NSString *)icon view:(UIView *)view
{
    ...
    hud.label.text = text;
//    hud.label.tintColor = _COLOR_WHITE;
//    hud.label.textColor = _COLOR_WHITE;
//    hud.detailsLabel.textColor = _COLOR_BLUE;
    hud.contentColor = _COLOR_BLACK;
    //hud.bezelView.style = MBProgressHUDBackgroundStyleSolidCo;
    hud.label.font = WGFOND(17);
    hud.userInteractionEnabled= NO;
    
//    hud.customView = [[UIImageView alloc] initWithImage:icon];  // 设置图片
    hud.bezelView.backgroundColor = _COLOR_LIGHT_GRAY;    //背景颜色
    // 设置图片
