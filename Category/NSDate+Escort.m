...
- (NSDateComponents *)deltaToNow
{
    ...
    int unit = kCFCalendarUnitYear | NSCalendarUnitMonth | NSCalendarUnitDay | NSCalendarUnitHour | NSCalendarUnitMinute | NSCalendarUnitSecond;
    ...
    return [calendar components:unit fromDate:self toDate:dateNow options:0];
}
@end
