...
//    UINavigationBar *bar = [UINavigationBar appearanceWhenContainedIn:[self class], nil];
    ...
    [bar setBackgroundImage:[UIImage createImageWithColor:UIColorFromHex(0x19C28C)] forBarMetrics:UIBarMetricsDefault];
    [bar setTitleTextAttributes:@{NSForegroundColorAttributeName : [UIColor whiteColor],NSFontAttributeName : [UIFont boldSystemFontOfSize:15]}];
    // 设置item
